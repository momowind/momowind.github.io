...
m4trace:acinclude.m4:4: -1- AC_DEFUN([AC_PROG_NASM], [
...
m4trace:acinclude.m4:144: -1- AC_DEFUN([AC_CHECK_COMPATIBLE_ARM_ASSEMBLER_IFELSE], [
...
m4trace:acinclude.m4:190: -1- AC_DEFUN([AC_CHECK_COMPATIBLE_MIPS_ASSEMBLER_IFELSE], [
  have_mips_dspr2=no
  ac_save_CFLAGS="$CFLAGS"
...
m4trace:acinclude.m4:217: -1- AC_DEFUN([AC_CHECK_COMPATIBLE_ARM64_ASSEMBLER_IFELSE], [
  ac_good_gnu_arm_assembler=no
  ac_save_CC="$CC"
  ac_save_CFLAGS="$CFLAGS"
  CFLAGS="$CCASFLAGS -x assembler-with-cpp"
...
m4trace:configure.ac:8: -1- _AM_SET_OPTIONS([-Wall foreign dist-bzip2])
...
m4trace:configure.ac:16: -1- AM_RUN_LOG([${MAKE-make} -f confmf.$s && cat confinc.out])
...
m4trace:configure.ac:17: -1- _AM_PROG_CC_C_O
m4trace:configure.ac:17: -1- AM_RUN_LOG([$CC -c conftest.$ac_ext -o conftest2.$ac_objext])
...
m4trace:configure.ac:18: -1- m4_pattern_allow([^AR$])
m4trace:configure.ac:19: -1- AM_PROG_AS
m4trace:configure.ac:19: -1- m4_pattern_allow([^CCAS$])
m4trace:configure.ac:19: -1- m4_pattern_allow([^CCASFLAGS$])
m4trace:configure.ac:19: -1- _AM_IF_OPTION([no-dependencies], [], [_AM_DEPENDENCIES([CCAS])])
m4trace:configure.ac:19: -2- _AM_MANGLE_OPTION([no-dependencies])
m4trace:configure.ac:19: -1- _AM_DEPENDENCIES([CCAS])
...
m4trace:configure.ac:23: -1- _LT_WITH_SYSROOT
...
m4trace:configure.ac:23: -1- _LT_DLL_DEF_P([$export_symbols])
m4trace:configure.ac:23: -1- _LT_DLL_DEF_P([$export_symbols])
...
m4trace:configure.ac:30: -1- PKG_PROG_PKG_CONFIG
...
m4trace:configure.ac:109: -1- PKG_CHECK_MODULES([libpng], [libpng], [HAVE_LIBPNG=1], [
...
m4trace:configure.ac:109: -1- PKG_CHECK_EXISTS([libpng], [pkg_cv_[]libpng_CFLAGS=`$PKG_CONFIG --[]cflags "libpng" 2>/dev/null`
		      test "x$?" != "x0" && pkg_failed=yes ], [pkg_failed=yes])
m4trace:configure.ac:109: -1- PKG_CHECK_EXISTS([libpng], [pkg_cv_[]libpng_LIBS=`$PKG_CONFIG --[]libs "libpng" 2>/dev/null`
		      test "x$?" != "x0" && pkg_failed=yes ], [pkg_failed=yes])
m4trace:configure.ac:109: -1- _PKG_SHORT_ERRORS_SUPPORTED
m4trace:configure.ac:109: -1- PKG_CHECK_MODULES([libpng], [libpng12], [HAVE_LIBPNG=1], [HAVE_LIBPNG=0])
m4trace:configure.ac:109: -1- m4_pattern_allow([^libpng_CFLAGS$])
m4trace:configure.ac:109: -1- m4_pattern_allow([^libpng_LIBS$])
m4trace:configure.ac:109: -1- PKG_CHECK_EXISTS([libpng12], [pkg_cv_[]libpng_CFLAGS=`$PKG_CONFIG --[]cflags "libpng12" 2>/dev/null`
		      test "x$?" != "x0" && pkg_failed=yes ], [pkg_failed=yes])
m4trace:configure.ac:109: -1- PKG_CHECK_EXISTS([libpng12], [pkg_cv_[]libpng_LIBS=`$PKG_CONFIG --[]libs "libpng12" 2>/dev/null`
		      test "x$?" != "x0" && pkg_failed=yes ], [pkg_failed=yes])
m4trace:configure.ac:109: -1- _PKG_SHORT_ERRORS_SUPPORTED
m4trace:configure.ac:109: -1- PKG_CHECK_MODULES([libpng], [libpng12], [HAVE_LIBPNG=1], [HAVE_LIBPNG=0])
m4trace:configure.ac:109: -1- m4_pattern_allow([^libpng_CFLAGS$])
...
m4trace:configure.ac:463: -1- AC_PROG_NASM
...
acinclude.m4:4: AC_PROG_NASM is expanded from...
configure.ac:463: the top level])
m4trace:configure.ac:468: -1- AC_PROG_NASM
...
acinclude.m4:4: AC_PROG_NASM is expanded from...
configure.ac:468: the top level])
m4trace:configure.ac:474: -1- AC_CHECK_COMPATIBLE_ARM_ASSEMBLER_IFELSE([if test "x$ac_use_gas_preprocessor" = "xyes"; then
           AC_MSG_RESULT([yes (with gas-preprocessor)])
         else
           AC_MSG_RESULT([yes])
         fi
         simd_arch=arm], [AC_MSG_RESULT([no])
         with_simd=no])
m4trace:configure.ac:474: -1- m4_pattern_allow([^CCAS$])
m4trace:configure.ac:494: -1- AC_CHECK_COMPATIBLE_ARM64_ASSEMBLER_IFELSE([if test "x$ac_use_gas_preprocessor" = "xyes"; then
           AC_MSG_RESULT([yes (with gas-preprocessor)])
         else
           AC_MSG_RESULT([yes])
         fi
         simd_arch=aarch64], [AC_MSG_RESULT([no])
         with_simd=no])
m4trace:configure.ac:494: -1- m4_pattern_allow([^CCAS$])
m4trace:configure.ac:514: -1- AC_CHECK_COMPATIBLE_MIPS_ASSEMBLER_IFELSE([AC_MSG_RESULT([yes])
         simd_arch=mips], [AC_MSG_RESULT([no])
         with_simd=no])
...
m4trace:configure.ac:619: -1- _AC_AM_CONFIG_HEADER_HOOK(["$ac_file"])
m4trace:configure.ac:619: -1- _AM_OUTPUT_DEPENDENCY_COMMANDS
m4trace:configure.ac:619: -1- AM_RUN_LOG([cd "$am_dirpart" \
      && sed -e '/# am--include-marker/d' "$am_filepart" \
        | $MAKE -f - am--depfiles])
m4trace:configure.ac:619: -1- _LT_PROG_LTMAIN
