...
@%:@ Generated by GNU Autoconf 2.69 for mozjpeg 3.2.
@%:@ 
@%:@ 
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures mozjpeg 3.2 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root @<:@DATAROOTDIR/doc/mozjpeg@:>@
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of mozjpeg 3.2:";;
   esac
  cat <<\_ACEOF
...
Optional Features:
  ...
  --disable-ld-version-script 
                          Disable linker version script for mozjpeg (default
                          is to use linker version script if the linker
                          supports it)
...
Use custom build string to enable reproducible builds (default: YYMMDD)
  --with-jpeg7            Emulate libjpeg v7 API/ABI (this makes mozjpeg
                          backward incompatible with libjpeg v6b.)
  --with-jpeg8            Emulate libjpeg v8 API/ABI (this makes mozjpeg
                          backward incompatible with libjpeg v6b.)
...
Some influential environment variables:
  ...
  SO_MAJOR_VERSION 
              Major version of the mozjpeg shared library (default is
              determined by the API version)
  SO_MINOR_VERSION 
              Minor version of the mozjpeg shared library (default is
              determined by the API version)
  ...
  PKGNAME     distribution package name (default: mozjpeg)
...
It was created by mozjpeg $as_me 3.2, which was
...
cat >>confdefs.h <<_ACEOF
@%:@define MOZJPEG_VERSION $VERSION
_ACEOF
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking whether to use version script when building mozjpeg" >&5
$as_echo_n "checking whether to use version script when building mozjpeg... " >&6; }
...
ac_config_files="$ac_config_files pkgscripts/mozjpeg.spec.tmpl:release/mozjpeg.spec.in"
