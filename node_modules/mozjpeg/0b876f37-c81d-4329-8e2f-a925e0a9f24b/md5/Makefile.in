...
am__depfiles_remade = ./$(DEPDIR)/md5cmp-md5.Po \
	./$(DEPDIR)/md5cmp-md5cmp.Po ./$(DEPDIR)/md5cmp-md5hl.Po
am__mv = mv -f
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/md5cmp-md5.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/md5cmp-md5cmp.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/md5cmp-md5hl.Po@am__quote@ # am--include-marker
...
distclean: distclean-am
		-rm -f ./$(DEPDIR)/md5cmp-md5.Po
	-rm -f ./$(DEPDIR)/md5cmp-md5cmp.Po
	-rm -f ./$(DEPDIR)/md5cmp-md5hl.Po
	-rm -f Makefile
